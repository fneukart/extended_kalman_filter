...
HOW TO RUN THE SIMULATOR WITH NEW DATA
1. Start the simulator
2. Click record data, and select the data directory, which also must contain the kalman-tracker.py
3. Go to command line and execute python kalman-tracker.py ../build/ExtendedKF
